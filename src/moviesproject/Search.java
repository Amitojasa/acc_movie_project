...
public class Search {
	...
	public static void searchMovieByActorName(GraphProcessingUtils customGraph) {
		...
		if (actorIsPresent) {
			...
			for (Integer i : listOfMovies) {
				System.out.print(
						GraphProcessingUtils.getCodeOfMovie(customGraph.getSymbolGraphForMoviesWithCast().name(i)) + ": ");
	...
	public static void searchMovieByMovieName(GraphProcessingUtils customGraph) {
		...
		if (setOfMovies != null && setOfMovies.size() > 0) {
			...
			for (int i : setOfMovies) {
				...
				System.out.print(GraphProcessingUtils.getCodeOfMovie(movieName) + ": ");
	...
	public static void searchMovieByGenre(GraphProcessingUtils customGraph) {
		...
		for (Integer i : listOfMovies) {
			System.out.print(GraphProcessingUtils.getCodeOfMovie(customGraph.getSymbolGraphForMoviesWithGenre().name(i)) + ": ");
